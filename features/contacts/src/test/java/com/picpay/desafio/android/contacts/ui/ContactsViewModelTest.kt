...
import com.picpay.desafio.android.contacts.ui.ContactFactory.CONTACT
...
internal class ContactsViewModelTest {
    ...
    private lateinit var action: (ContactsViewAction) -> Unit
    private val navigation: ContactsNavigation = mockk()
